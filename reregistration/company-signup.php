...
if (!empty($_POST['next2']) && $_POST['next2'] == "確認画面へ") {
	...
	if ($signError == "") {
		...
		header("Location:/verification-company.php");
		exit();
	}
}
					...
					<div class="loginBox">
						<form action="" method="post">
							...
							<div class="inputBox">
								...
								<div class="inputBoxAddress cf">
									<div class="addressBox post">
										<input type="text" name="u_postal1" value="<?php echo $_SESSION['u_postal1']; ?>" maxlength="3" placeholder="123" required>-<input type="text" name="u_postal2" value="<?php echo $_SESSION['u_postal2']; ?>" maxlength="4" onKeyUp="AjaxZip3.zip2addr('u_postal1','u_postal2','u_address1','u_address2','u_address2');" placeholder="4567" required>
									...
									<div class="addressBox">
										...
										<input type="text" class="form-control" name="u_address1" value="<?php echo $_SESSION['u_address1']; ?>" required placeholder="東京都">
									</div>
									<div class="addressBox">
							...
							<div class="inputBox">
								...
								<input type="text" class="form-control" name="u_tel" value="<?php echo $_SESSION['u_tel']; ?>" required>
							</div>
							<div class="inputBox">
