...
<body>
	<!-- カード情報入⼒フォーム -->
	<form action="https://sapocup.jp/paygent/post_delete.php" method="POST" name="card_form">
		<div>カード番号︓<input type="text" name="card_number" value="4900000000000000"></div>
		<div>有効期限（年）︓<input type="text" name="expire_year" value="30"></div>
		...
		<input type="button" name="btn" value="停止" onClick="send();">
