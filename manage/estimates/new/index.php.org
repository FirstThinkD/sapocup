...
if (!empty($_POST['send2']) && $_POST['send2'] == "シミュレーション画面へ") {
	...
	// echo "qu_startDate=". $qu_startDate. " qu_paymentDate=". $_POST['qu_paymentDate']. " error=". $error. "<br>";
	// exit();
	if ($error == "") {
		if ($_POST['qu_paymentDate'] == "末日") {
...
// echo "error=". $error. " qu_bunrui2=". $qu_bunrui2. " qu_startDate2=". $qu_startDate2. " P_qu_startDate=". $_POST['qu_startDate'];
// echo "error=". $error. " q_count=". $q_count;
// for($ix=0; $ix<$q_count; $ix++) {
