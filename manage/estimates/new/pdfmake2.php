...
//    let pdf_delivery  = "<?php echo $qu_deliveryDate; ?>"; // 受渡期日
    ...
    let pdf_date      = ""; //日付
    let pdf_billto    = ""; // 請求先
    let pdf_construct = ""; // 請求先
    let pdf_company   = ""; // 会社名
    let pdf_post      = "";
    let pdf_address1  = ""; // 住所1
    let pdf_address2  = ""; // 住所2
    let pdf_address3  = ""; // 住所3
    let pdf_tel       = ""; // 電話番号
    let pdf_name      = ""; // 名前
    let pdf_place     = ""; // 工事場所
    let pdf_payment   = ""; // 支払い日
    let pdf_delivery  = ""; // 受渡期日
...
//    let pdf_item_remarks = "<?php echo $row7['memo']; ?>"; // 備考

    let pdf_estimate_constructionprice = ""; // 工事価格
    let pdf_estimate_totalprice   = ""; // 請求金額合計
    let pdf_estimate_tax          = ""; // 消費税
    let pdf_estimate_installment  = ""; // 割賦手数料
    let pdf_estimate_firstpayment = ""; // 初回お支払額
    let pdf_estimate_montylypayment = ""; // 月々お支払額
    let pdf_estimate_split   = ""; // 分割回数
    let pdf_estimate_deposit = ""; // 頭金
    let pdf_estimate_start   = ""; // 返済開始予定年月
    let pdf_estimate_fin     = ""; // 返済終了予定年月

    let pdf_item_name   = ""; // 項目名前
    let pdf_item_num    = ""; // 数量
    let pdf_item_unit   = ""; // 単位
    let pdf_item_price  = ""; // 単価(税込)
    let pdf_item_amount = ""; // 金額

    let pdf_item_shokei = ""; // 小計
