...
<body>
  <main>
    <button onClick="pdfMake.createPdf(docDefinition).open();return false;">別ウインドウでPDFを表示</button>
    <button onClick="pdfMake.createPdf(docDefinition).print();return false;">PDFを印刷</button>
    <button onClick="pdfMake.createPdf(docDefinition).download('optionalName.pdf');return false;">PDFをダウンロード</button>
  </main>
  ...
  <script>
    ...
    --------------------------------------------------------------------------*/
      ...
      ---------------------------------------*/
        {
          text: "割賦販売契約約款", bold: true, margin: [5,130, 5, 0],
        },
        {
          layout: 'noBorders',
          margin: [5, 0, 5, 0],
          ...
          table: {
            ...
            body: [[
              [
                ...
                { text: "第５条（商品引渡し及び所有権の移転）", style: "backText"},
                { margin: [ 5, 0, 0, 0],
                  columns: [
                  { width: 10, text: "1."},
                ...
                { margin: [ 5, 0, 0, 0],
                  columns: [
                  { width: 10, text: "3."},
                  { width: "auto", text: "乙は、本商品の所有権移転前においては、本商品を担保に供し、譲渡し、または転売することができないものとします。"},
                ],},
                { text: "第６条（届出事項の変更）", style: "backText", },
                { ol: ['乙は、甲に届け出た氏名もしくは名称、住所または連絡先等を変更した場合は、速やかに甲所定の方法により甲に届け出るものとします。', '乙は、前項の届出がないために、甲等からの通知または送付書類等が延着または不到達となった場合には、通常到達すべき時に到達したものと甲等がみなすことに異議のないものとします。'], margin: [ 5, 0, 0, 0], },
                { text: "第７条（契約上の地位の譲渡）", style: "backText"},
                { margin: [ 5, 0, 0, 0],
                  columns: [
                  { width: 10, text: "1."},
                ...
                { margin: [ 5, 0, 0, 0],
                  columns: [
                  { width: 10, text: "2."},
                  { width: "auto", text: "前項の定めは、相続または法人の合併、分割等により本契約に係る契約定の地位が承継される場合には適用しないものとします。"},
                ],},
                { text: "第８条（期限の利益喪失）", style: "backText"},
                { margin: [ 5, 0, 0, 0],
                  columns: [
                  { width: 10, text: "1."},
                ...
                { text: "第１０条（手数料の負担等）", style: "backText"},
                { text: "乙は、分割代金の支払に関する手数料を負担するものとします。"},
              ],
              { text: ""},
              [
                { text: "第１１条（早期一括返済）", style: "backText"},
                { text: "乙は、甲等に申し出ることにより、分割払金の残額を一括して支払うことができるものとします。"},
                { text: "第１２条（反社会的勢力との関係の遮断）", style: "backText"},
                { margin: [ 5, 0, 0, 0],
                  columns: [
                  { width: 10, text: "1."},
                  { width: "auto", text: "乙は本契約締結日において、暴力団、暴力団員、暴力団員でなくなった時から５年を経過しない者、暴力団準構成員、暴力団関係企業、総会屋等、社会運動等標ぼうゴロ又は特殊知能暴力集団等、これらの共生者、その他これらに準ずる者、テロリスト（疑いがある場合も含む）に該当しないことを表明し、かつ将来にわたっても該当しないことを確約します。.00％を上限とした額の遅延損害金を支払うものとします。"},
                ],},
                { margin: [ 5, 0, 0, 0],
                  columns: [
                  { width: 10, text: "2."},
                  { width: "auto", text: "乙が第１項各号に該当した場合、またはは第１項の規定に基づく確約に関して虚偽の申告をしたことが判明した場合、甲は直ちに本契約を解除することができ、且つ、甲に生じた損害の賠償を請求できるものとします。.00％を上限とした額の遅延損害金を支払うものとします。"},
                ],},
                { text: "第１３条（割賦債権の譲渡）", style: "backText"},
                { text: "甲は、乙に対する本契約に基づく債権を第三者に譲渡することがあります。この場合において、ご契約者様は、当該債権の譲渡及び甲が購入者の個人情報を譲渡先に提供することをあらかじめ同意するものとします。"},
                { text: "第１４条（個人情報の取扱い）", style: "backText"},
                { text: "甲は乙に関する個人情報の取扱いに関するプライバシーポリシーを定め、これを甲のホームページ等において公表するか、甲の求めに応じて遅滞なく回答します。"},
                { text: "第１５条（合意管轄裁判所）", style: "backText"},
                { text: "乙は、本商品、本約款及び本契約について紛争が生じた場合、訴額の如何にかかわらず、甲の本店所在地を管轄する地方裁判所を第一審の専属的合意管轄裁判所とすることに同意するものとします。"},
                { text: "第１６条（補則）", style: "backText"},
                ...
                { margin: [ 0, 0, 0, 0],
                  columns: [
                  { width: 8, text: "・", style: "coolingOff"},
                  { width: "auto", text: "お客様からのご請求によりご自宅での契約の申込みまたは契約締結がなされた場合上記期間内にクーリングオフがあった場合、甲は契約の解除に伴う損害賠償", style: "coolingOff"},
                ],},
                { text: "または違約金支払を請求することはありません。万一、クーリングオフがあった場合に、既に商品等の引渡しが行われている時は、その引取りに要する費用は甲の負担とします。また、契約解除のお申し出の際に既に受領した金員がある場合、すみやかにその金額を無利息にて返還いたします。", style: "coolingOff"},
              ],
            ]]
          },
        },
      ...
      ---------------------------------------*/
        {
          text: "割賦販売契約約款", bold: true, margin: [5,155, 5, 0],
        },
        {
          layout: 'noBorders',
          margin: [5, 0, 5, 0],
    ...
    // console.dir(docDefinition.content[14]);
    docDefinition.content.splice( 23, 50 );
    // docDefinition.content.splice( 48, 25 );
    // for(var i=13; i< q_cont + 13; i++) {
        docDefinition.content[13].table.body[0][2].text = 'AAA';
    // }
  </script>
</body>
</html>