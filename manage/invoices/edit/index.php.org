...
//	}
	...
	if ($error == "") {
		...
		list($qu_endDate, $error) = ymtoymd($_POST['qu_endDate'], $qu_paymentDate);
...
//		}
		...
		$sql = sprintf('UPDATE `quotation` SET c_id="%d", u_id="%d",
			...
			syohkei="%s", txt_cont="%d", txt_line="%d", updated=NOW() WHERE qu_id="%d"',
				...
				data:function () {
					return {
						...
						items: [
						    ...
						    { id: 8, asset: '未選択', types: [
						        { tId: 0, use: '未選択', details: [
						            {dId: 0, label: '未選択', life: '' },
						        ]},
						    ]},
						    { id: 9, asset: '', types: [
						        { tId: 0, use: '', details: [
